        ...
        pub mod calculate {
            ...
            pub fn eval_expression(op: Op, x: u32, y: u32) -> u32 {
                unsafe {
                    ...
                    #[link(wasm_import_module = "math:calculator/calculate@0.1.0")]
                    unsafe extern "C" {
...
#[cfg(target_arch = "wasm32")]
#[unsafe(link_section = "component-type:wit-bindgen:0.41.0:cli:app:app:encoded world")]
#[doc(hidden)]
...
B\x04\x01m\x02\x03add\x08multiply\x04\0\x02op\x03\0\0\x01@\x03\x02op\x01\x01xy\x01\
yy\0y\x04\0\x0feval-expression\x01\x02\x03\0\x1fmath:calculator/calculate@0.1.0\x05\
\0\x04\0\x0bcli:app/app\x04\0\x0b\x09\x01\0\x03app\x03\0\0\0G\x09producers\x01\x0c\
